...
export const TWITTER_QUERY_SYNTAX_QUERY_TOOLTIP =
  'Combine search operators such as "AND" to find tweets with all terms, "OR" to find tweets with at least one term, and "from:" to search for tweets from a specific user. For example, "q=apple%20pie%20from%3Auser1" will search for tweets containing "apple" and "pie" from the user with screen name "user1".';
